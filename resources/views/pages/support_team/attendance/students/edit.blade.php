...
<div class="card">
    <div class="card-header header-elements-inline">
        <h6 class="card-title">Edit Attendance for {{ $attendance->student->user->name }}</h6>
        <div class="header-elements">
            <a href="{{ route('attendance.student.manage', ['class_id' => $attendance->class_id, 'section_id' => $attendance->section_id, 'date' => $attendance->date]) }}" class="btn btn-secondary">Go Back</a>
        </div>
    </div>

    <div class="card-body">
        <form method="post" action="{{ route('attendance.student.update', $attendance->id) }}">
            @csrf
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <label>Student Name:</label>
                        <input type="text" class="form-control" value="{{ $attendance->student->user->name }}" readonly>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label>Admission No:</label>
                        <input type="text" class="form-control" value="{{ $attendance->student->adm_no }}" readonly>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        <label>Section:</label>
                        <input type="text" class="form-control" value="{{ $attendance->section->name }}" readonly>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
