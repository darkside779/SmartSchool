    ...
    <div class="sidebar-content">
        ...
        <div class="card card-sidebar-mobile">
            <ul class="nav nav-sidebar" data-nav-type="accordion">
                ...
                @if(Qs::userIsAdmin() || Qs::userIsSuperAdmin() || Qs::userIsAttendance())
                <li class="nav-item">
                <li class="nav-item nav-item-submenu">
                    ...
                    <ul class="nav nav-group-sub" data-submenu-title="Attendance">
                        <li class="nav-item">
                            <a href="{{ route('attendance.student') }}" class="nav-link">
                                Student Attendance
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('attendance.teacher') }}" class="nav-link">
                                Teacher Attendance
                            </a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('attendance.teacher.report') }}" class="nav-link">
                                Teacher Report
                            </a>
                        </li>
                    </ul>
